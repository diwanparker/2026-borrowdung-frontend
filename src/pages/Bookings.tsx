  ...
  return (
    <div>
      ...
      <div className="mb-6 flex gap-4 flex-wrap">
        ...
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value === '' ? '' : parseInt(e.target.value) as BookingStatus)}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="bg-blue-50 border-l-4 border-blue-500 p-3 mb-4">
                <p className="text-sm text-blue-800">
                  <strong>Langkah 1:</strong> Pilih waktu peminjaman terlebih dahulu untuk melihat ruangan yang tersedia
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, startTime: e.target.value, roomId: 0 })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, endTime: e.target.value, roomId: 0 })}
                  className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none"
                />
              </div>
                ...
                <>
                  <div className="bg-green-50 border-l-4 border-green-500 p-3">
                    <p className="text-sm text-green-800">
                      <strong>{availableRooms.length} ruangan tersedia</strong> untuk waktu yang dipilih
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    >
                      <option value={0}>
                        {availableRooms.length === 0 ? 'Tidak ada ruangan tersedia' : 'Pilih Ruangan'}
                      </option>
              ...
              <div className="flex gap-2 pt-4">
                ...
                <button
                  type="submit"
                  disabled={!formData.startTime || !formData.endTime || availableRooms.length === 0}
